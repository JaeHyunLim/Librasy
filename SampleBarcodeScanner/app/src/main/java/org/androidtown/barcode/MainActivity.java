...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button b = (Button)findViewById(R.id.lendBtn);
        b.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("name","안드로이드 프로그래밍");
                intent.putExtra("author","천인국");
                intent.putExtra("publisher","생능출판");
                intent.putExtra("T/F","대출가능");
...
/*
    // public void ReturResult() {
    //intent 생성
    Intent intent1 = new Intent(getApplicationContext(), ScanResult.class);
// 데이터를 intent 에 실어 보내기
intent1.putExtra("name","안드로이드 프로그래밍");
        intent1.putExtra("author","천인국");
        intent1.putExtra("publisher","생능출판");
        intent1.putExtra("T/F","대출가능");
